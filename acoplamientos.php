...
<div style="width: 100%; min-width: 320px; max-width: 1000px; margin: 0 auto;">
		...
		<a href="index.php?seccion=productos&parte=elasticos" class="cuadros">
			<div id="cuadros">
				...
				<div id="titulo">El&Aacutesticos &raquo</div>
			</div>
		</a>
		...
		<a href="#" class="cuadros">
			<div id="cuadros">
				...
				<div id="titulo">Juego Cero Limitadores de Par &raquo</div>
			</div>
		</a>
		
		<a href="#" class="cuadros">
			<div id="cuadros">
				<div id="img"><img src="images/catalogo/acoplamientos_precision_serie_mjt.png" class="img"  /></div>
				<div id="titulo">De Precisi&Oacuten &raquo</div>
			</div>
		</a>
